...
<script src="./src/mode-markdown-uncompressed.js" type="text/javascript" charset="utf-8"></script>
<script src="./src/mode-latex-uncompressed.js" type="text/javascript" charset="utf-8"></script>
<script type="text/javascript" src="http://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML"></script>

<script src="./js/jquery.terminal-0.4.7.js" type="text/javascript" charset="utf-8"></script>
<link type="text/css" rel="stylesheet" href="./css/jquery.terminal.css"/>

<script src="./src/mode-lua.js" type="text/javascript" charset="utf-8"></script>
...
<div id="content">
	...
	<div id="bottom" style="position:fixed; bottom:-3px; left: 30px; border-radius: 4px; padding: 10px; background:#DB4C69; color:#fff; box-shadow: 0 0 5px #db4c69; cursor:pointer; font-weight:bold; opacity:0.8; z-index:2;">SYNC
	</div>
</div>
</body>
</html>